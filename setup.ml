...
(* OASIS_START *)
(* DO NOT EDIT (digest: f21bb3c16f534aea674dcb6f82aba0b1) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Ldap_funclient"; "Ldap_ooclient"; "Ldap_txooclient"
                        ];
                      lib_pack = false;
                      lib_internal_modules =
                        [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "client"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "O5\023\168<\252&\215\1450X\129\237\235\241\131";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
