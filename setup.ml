...
(* OASIS_START *)
(* DO NOT EDIT (digest: 79910871112f69a5fdaf905511505ae3) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_page_control", []))];
            ...
            [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Ocamldap";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ldap"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "lber_tests.ml"});
               Executable
                 ({
                     cs_name = "testldif";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "testldif.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "testoo.ml"});
               Executable
                 ({
                     cs_name = "test-page-control";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "page_result_control_test.ml"
                   });
               Test
                 ({
                     cs_name = "all";
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test-page-control"
                        ]
                   })
            ];
     ...
     oasis_digest = Some "\209\138\004\223\tu\130L\183i[\194L\127\252\177";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
