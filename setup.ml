...
(* OASIS_START *)
(* DO NOT EDIT (digest: 624d6366d7e4d055c9989f8d8a4bd56f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Ocamldap is an implementation of the Light Weight Directory\nAccess Protocol";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\146W\228\228r\217{\192l\220K3PDrw";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
