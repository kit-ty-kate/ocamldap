...
(* OASIS_START *)
(* DO NOT EDIT (digest: d96716c95649a2049e5cbfc0d81ce86e) *)
(*
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISContext.ml" *)
...
(* # 1 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISString.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISUtils.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/PropList.ml" *)
...
(* # 71 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/PropList.ml" *)
  end
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISMessage.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISVersion.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISLicense.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISTypes.ml" *)
...
(* # 102 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISTypes.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISUnixPath.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISHostPath.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISSection.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISBuildSection.ml" *)
  
end

module OASISExecutable = struct
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISExecutable.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISLibrary.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISFlag.ml" *)
  
end

module OASISPackage = struct
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISPackage.ml" *)
  
end

module OASISSourceRepository = struct
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISSourceRepository.ml" *)
  
end

module OASISTest = struct
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISTest.ml" *)
  
end

module OASISDocument = struct
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISDocument.ml" *)
  
end

module OASISExec = struct
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISExec.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/oasis/OASISFileUtil.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseContext.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseMessage.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseEnv.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseArgExt.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseCheck.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseOCamlcConfig.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseStandardVar.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseFileAB.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseLog.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseBuilt.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseCustom.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseDynVar.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseTest.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseDoc.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/base/BaseSetup.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/plugins/internal/InternalConfigurePlugin.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/plugins/internal/InternalInstallPlugin.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/plugins/ocamlbuild/OCamlbuildCommon.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/plugins/ocamlbuild/OCamlbuildPlugin.ml" *)
...
(* # 21 "/tmp/yaourt-tmp-root/aur-ocaml-oasis/src/oasis-0.3.0/src/plugins/ocamlbuild/OCamlbuildDocPlugin.ml" *)
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Eric Stokes"; "Jacques-Pascal Deplaix"];
          homepage = None;
          synopsis =
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["caseIgnoreCompare.c"];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "ldif"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      ...
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-I"; "+compiler-libs"])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])];
                      },
                   {
                      lib_modules = ["Ldap_toplevel"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ldap";
                      lib_findlib_name = None;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "c\b\251\213`1kf\131\029\235a\131\239\159;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
