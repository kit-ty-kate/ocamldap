...
(* OASIS_START *)
(* DO NOT EDIT (digest: 50ba06e2fef5809a43abe04765771ccc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Eric Stockes"; "Jacques-Pascal Deplaix"];
          homepage = None;
          synopsis =
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\151\190\135$q\210\225\220\027\002\014\225\020\\\185\016";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
