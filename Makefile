...
ldap_funclient.ml ldap_schemalexer.mll ldap_schema.mli			\
caseIgnoreCompare.c ldap_schema.ml ldap_dnparser.mly ldap_dnlexer.mll	\
ldap_dn.mli ldap_dn.ml ldap_ooclient.mli ldap_ooclient.ml		\
ldap_syntaxes.ml ldap_matchingrules.ml ldap_schemavalidator.ml		\
ldap_schemacheck.ml ldap_mutex.mli ldap_mutex.ml ldap_txooclient.mli	\
ldap_txooclient.ml ldif_parser.ml ldif_oo.ml ldif_oo.mli		\
ldap_funserver.mli ldap_funserver.ml ldif_changerec_parser.mly		\
ldif_changerec_lexer.mll ldif_changerec_oo.mli ldif_changerec_oo.ml	\
ldap_toplevel.ml
RESULT=ocamldap
